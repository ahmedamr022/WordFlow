...
export default function StatsPage() {
  ...
  const cards = [
    ...
    { label: "إجمالي النقاط", value: stats.xpTotal.toLocaleString(), icon: Star, color: "text-amber-400" },
    { label: "القصص المكتملة", value: `${stats.storiesCompleted} / ${totalStories}`, icon: BookOpen, color: "text-cyan-400" },
    { label: "المفردات المحفوظة", value: stats.wordsLearned.toLocaleString(), icon: Target, color: "text-fuchsia-400" },
  ];
